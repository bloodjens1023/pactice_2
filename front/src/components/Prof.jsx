...
function Prof() {
    return ( 
        <nav class="navbar navbar-expand bg-white shadow mb-4 topbar static-top navbar-light">
            <input class="form-control form-control" type="text" placeholder="Rechercher votre produit" style={{marginLeft:"10px"}}/>
            ...
            <label class="theme-switch">
                ...
                <ul class="navbar-nav flex-nowrap ms-auto">
                    ...
                    <li class="nav-item dropdown no-arrow mx-1" style={{display:"flex", alignItems:"center", justifyContent:"center"}}>
