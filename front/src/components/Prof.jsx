...
function Prof() {
    return ( 
        <nav className="navbar navbar-expand  shadow mb-4 topbar static-top navbar-light" style={{backgroundColor:"#1F4743", color:"white"}}>
            <input className="form-control form-control" type="text" placeholder="Rechercher votre produit" style={{marginLeft:"10px"}}/>
            ...
            <label className="theme-switch">
                ...
                <ul className="navbar-nav flex-nowrap ms-auto">
                    ...
                    <li className="nav-item dropdown no-arrow mx-1" style={{display:"flex", alignItems:"center", justifyContent:"center"}}>
                        <img src={img} alt="" srcSet="" width={30} />700 Tc
                    </li>
