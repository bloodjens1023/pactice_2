...
function Inscription() {
    ...
    function handleChange(e) {
        e.preventDefault()
        axios.post('http://localhost:8000/api/inscription',{nom,prenom,email,pass})
        .then(res =>{
        ...
        <>
            ...
            <div className="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
                ...
                <div className="col-lg-6 mb-5 mb-lg-0" style={{zIndex:10}} >
                    ...
                    Ecosort <br />
                    <span style={{color:"hsl(218, 81%, 75%)"}}>Ameliorer votre entourage</span>
                    </h1>
                    <p className="mb-4 opacity-70" style={{color:"hsl(218, 81%, 85%)"}}>
                    Afin d'améliorer votre entourage et faire du recyclage votre loisir, il est nécesaire de s'inscrire si vous n'êtes pas encore membre
                    </p>
                </div>
                ...
                <div className="col-lg-6 mb-5 mb-lg-0 position-relative">
                    ...
                    <div className="card-body px-4 py-5 px-md-5">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-4">
                            <div className="form-outline">
                                <input type="text" id="form3Example2" className="form-control" value={prenom} onChange={e => setPrenom(e.target.value)}/>
                        ...
                        <div className="form-outline mb-4">
                            <input type="password" id="form3Example4" className="form-control" value={pass} onChange={e => setPass(e.target.value)}/>
                        ...
                        <center>
                            <Link to="/Connexion"><hr /> J'ai déja un compte</Link>
                        </center>
                        </form>
                    </div>
                    </div>
