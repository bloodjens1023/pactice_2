...
function Dashboard() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        const totalProduits = res.data.length;
        const totalTonne = totalProduits / 1000;
        setProd(totalTonne);
      })
      .catch((error) => {
        console.error(
                  ...
                  <div className="card shadow">
                    ...
                    >
                      <h1 style={{ fontSize: "2rem", paddingTop: "30px" }}>
                        <CountUp start={0} end={prod} duration={2} decimals={4} />
                    ...
                    <div className="card shadow">
                      ...
                      >
                        <p
                          ...
                          style={{ color: "#173734" }}
                        >
                          L'empreinte ecologuique de madagascar a l'echeille
                          Mondiale
                        </p>
                      </div>
                      <div
