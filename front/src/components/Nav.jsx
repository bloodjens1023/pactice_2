        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item">
            ...
            >
              ...
              <div style={{ marginTop: "2px" }} className={props.marcher}>
                Marché
              </div>
            </Link>
          </li>
          <li className="nav-item">
            ...
            >
              ...
              <div style={{ marginTop: "2px" }} className={props.event}>
                Evènements
              </div>
            </Link>
          </li>
          <li className="nav-item">
            ...
            >
              ...
              <div style={{ marginTop: "2px" }} className={props.panier}>
                Votre paniers
                <Badge
                  pill
                  bg="secondary"
          ...
          <li className="nav-item">
            ...
            >
              ...
              <div style={{ marginTop: "2px" }} className={props.vendre}>
                Vendre
              </div>
            </Link>
          </li>
          <li className="nav-item">
            ...
            >
              ...
              <div style={{ marginTop: "2px" }} className={props.stat}>
                Statistique
              </div>
            </Link>
          </li>
          <li className="nav-item">
            ...
            >
              ...
              <div style={{ marginTop: "2px" }} className={props.prof}>
                Profils
              </div>
            </Link>
          </li>
