    ...
    return (
        ...
        <div className=" vertical-nav" style={{ borderRadius: "0px 0px 40px" }}>
            <ul className="nav flex-column">
                ...
                <li className="nav-item">
                    <Link className="nav-link" to='/dash' style={{ display: "flex", alignItems: "start", gap: "4px" }}>
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-fill" viewBox="0 0 16 16" style={{ fontSize: "25px", marginRight: "10px" }}>
