...
{!visible && (
    ...
    <motion.div className="containerss " style={{ padding: "100px", width: "97vw", display: 'flex', flexDirection: "column", alignItems: "center", justifyContent: "center", paddingLeft:"25%"}}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
