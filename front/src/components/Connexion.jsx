...
function Connexion() {
  ...
  const handleConnexion = (event) => {
    // Prevent the default behavior of the form submission (i.e., refreshing the page)
    event.preventDefault();

    // Vérifier que les champs d'adresse email et de mot de passe sont remplis
    if (!addr || !mdp) {
      alert("Veuillez remplir tous les champs");
      return;
    }
    Cookies.set("user", addr, { expires: 7, path: "/" });
                  ...
                  <form onSubmit={handleConnexion}>
                    ...
                    <center>
                      <Link to="/Inscription" style={{ color: "white" }}>
                        <hr /> Je ne suis pas encore membre
                      </Link>
                    </center>
                  </form>
                </div>
