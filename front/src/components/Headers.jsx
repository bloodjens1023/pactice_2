...
function Headers() {
    return ( 
        <nav className="navbar navbar-light navbar-expand-md  navbar-shrink py-3" id="mainNav">
            <div className="container"><Link className="navbar-brand d-flex align-items-center" to="/"><span className="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-bezier">
                        ...
                        </svg></span><span>Ecosort</span></Link><button data-bs-toggle="collapse" className="navbar-toggler" data-bs-target="#navcol-1"><span className="visually-hidden">Toggle navigation</span><span className="navbar-toggler-icon"></span></button>
                <div className="collapse navbar-collapse" id="navcol-1">
                    <ul className="navbar-nav mx-auto"></ul>
                    <Link className="btn btn-outline-primary shadow" role="button" to="/connexion" style={{marginRight:"10px"}}>Connexion</Link>
                    <Link className="btn btn-primary shadow" role="button" to="/inscription">Inscription</Link>
                </div>
            </div>
        </nav>
     );
